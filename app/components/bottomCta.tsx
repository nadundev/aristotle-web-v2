        ...
        <LampContainer>
          ...
          >
            <button className="relative inline-flex h-12 overflow-hidden rounded-full p-[1px] focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-brand-50">
              ...
              <span className="inline-flex h-full w-full cursor-pointer items-center justify-center rounded-full bg-black px-6 py- text-2xl font-medium text-white backdrop-blur-3xl hover:bg-brand-400 hover:text-white transition duration-300">
