...
const Header = () => {
  ...
  return (
    <>
      ...
      >
        <nav
          className="flex items-center justify-between mx-auto max-w-[1024px] py-3 px-4 sm:px-8"
          aria-label="Global"
        >
          ...
          <div className="hidden lg:flex lg:gap-x-12">
            <a
              href="#why"
              className="text-sm font-medium leading-6 text-white hover:text-brand-300 transition-colors duration-300"
            >
              Why
            </a>
            <a
